...
mkdir -p $GOPATH/src/github.com/DistributedMonitoringSystem
cd $GOPATH/src/github.com/DistributedMonitoringSystem
git clone https://github.com/DistributedMonitoringSystem/graph.git
...
你也可以从[这里](https://github.com/DistributedMonitoringSystem/graph/releases)，下载 Open-Falcon 官方最新的release安装包，避免源码编译的种种问题。
