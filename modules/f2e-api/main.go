...
import (
	...
	"github.com/DistributedMonitoringSystem/open-falcon-backend/modules/f2e-api/app/controller"
	"github.com/DistributedMonitoringSystem/open-falcon-backend/modules/f2e-api/config"
	"github.com/DistributedMonitoringSystem/open-falcon-backend/modules/f2e-api/graph"
	jconf "github.com/DistributedMonitoringSystem/open-falcon-backend/modules/f2e-api/lambda_extends/conf"
